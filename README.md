...
| 任务 | 数据 | 词表/难度 | 指标 |
|---|---|---|---|
| 文本识别 | 合成 3000 张（全增强） | 10 数字 | **整串 98.5%** |
| 文本识别 | 合成 5000 张（全增强） | 36 字母数字 | **整串 94.5%** |
| 文本检测 | 合成整图 | 随机文本框 | **二值掩膜 IoU 94.3%** |
| 文本检测 | MSRA-TD500 | 真实场景（SynthText 预训练中）| 见 Roadmap |
